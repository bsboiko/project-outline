...
var nodes = [
      { name: "\"Progress\"", target: [0, 2, 4, 8], value: 90 },
      { name: "\"Where to go\"", target: [0], value: 58 },
      { name: "\"Our Community\"", target: [0, 1], value: 65 },  
      { name: "\"Services I Need\"", target: [0, 1, 2], value: 52 },
      { name: "\"Daily Needs\"", target: [0, 3], value: 40 }, 
      { name: "\"Help Right Now\"", target: [0,3,4], value: 50 }, 
      { name: "Word Of Mouth", target: [0,3,4,5], value: 80 },
      { name: "\"A Friend\"", target: [0, 1, 2], value: 52 },
